...
const formData = {
    ...
    challenges: Array.isArray(getFieldValue('challenges')) ? getFieldValue('challenges') : [],
    integrations: Array.isArray(getFieldValue('integrations')) ? getFieldValue('integrations') : [],
    ...
    target_problems: Array.isArray(getFieldValue('challenges')) ? 
        getFieldValue('challenges').join(', ') : 'Not specified',
