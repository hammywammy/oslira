// =============================================================================
// STAGING GUARD - IMMEDIATE PROTECTION
// Runs before any other scripts to ensure comprehensive protection
// =============================================================================
...
(function() {
    ...
    console.log('🔒 Staging environment detected - immediate protection check');
    ...
    if (!isAuthenticated()) {
        ...
        // Show staging protection when DOM is ready
    ...
    function createPasswordPrompt() {
        ...
        fetch('/api/config')
            ...
            .catch(error => {
                ...
                // Allow access if config fails to load
                document.documentElement.style.visibility = 'visible';
            });
    }
